...
{
    public partial class TraspasoTiendaVitrina : Form
    {
        string usuarioMyB;
        public TraspasoTiendaVitrina()
        {
            InitializeComponent();
        }

        public TraspasoTiendaVitrina(string usuario)
        {
            InitializeComponent();
            usuarioMyB = usuario;
        }
...
#pragma warning restore CS0168 // La variable 'e' se ha declarado pero nunca se usa
            ...
            else if (tienda == "VALLARTA")
            {
                try
                {
                    conex_traspasos = BDConexicon.V_vallarta();
                    selectDatos();
...
#pragma warning restore CS0168 // La variable 'e' se ha declarado pero nunca se usa
            ...
            else if (tienda == "RENA")
            {
                try
                {
                    conex_traspasos = BDConexicon.V_rena();
                    selectDatos();
...
#pragma warning restore CS0168 // La variable 'e' se ha declarado pero nunca se usa
            ...
            else if (tienda == "VELAZQUEZ")
            {
                ...
                try
                {
                    conex_traspasos = BDConexicon.V_velazquez();
                    selectDatos();
...
#pragma warning restore CS0168 // La variable 'e' se ha declarado pero nunca se usa
            ...
            else if (tienda == "COLOSO")
            {
                ...
                try
                {
                    conex_traspasos = BDConexicon.V_coloso();
                    selectDatos();
...
#pragma warning restore CS0168 // La variable 'e' se ha declarado pero nunca se usa
            ...
            else if (tienda == "PREGOT")
            {
                ...
                try
                {
                    conex_traspasos = BDConexicon.V_pregot();
                    selectDatos();
                    lblConexion.Text = "Conectado PM";
                    lblConexion.ForeColor = Color.DarkGreen;
                }
#pragma warning disable CS0168 // La variable 'e' se ha declarado pero nunca se usa
                catch (Exception e)
#pragma warning restore CS0168 // La variable 'e' se ha declarado pero nunca se usa
                {
                    lblConexion.Text = "Sin Conexion PM";
                    lblConexion.ForeColor = Color.Red;
                    limpiarTraspaso();
                }
        ...
        private void dgvTraspasos_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //}
            if (cbTienda.Text == "VALLARTA")
            {
                conex_datostraspaso = BDConexicon.V_vallarta();
                selectDatosTraspaso(idTraspaso);
                itemTraspaso(idTraspaso);
                conex_datostraspaso.Close();
            }
            ...
            {
                conex_datostraspaso = BDConexicon.V_rena();
                selectDatosTraspaso(idTraspaso);
                itemTraspaso(idTraspaso);
                conex_datostraspaso.Close();
            }
            ...
            {
                conex_datostraspaso = BDConexicon.V_velazquez();
                selectDatosTraspaso(idTraspaso);
                itemTraspaso(idTraspaso);
                conex_datostraspaso.Close();
            }
            ...
            {
                conex_datostraspaso = BDConexicon.V_coloso();
                selectDatosTraspaso(idTraspaso);
                itemTraspaso(idTraspaso);
                conex_datostraspaso.Close();
            }
            ...
            {
                conex_datostraspaso = BDConexicon.V_pregot();
                selectDatosTraspaso(idTraspaso);
                itemTraspaso(idTraspaso);
                conex_datostraspaso.Close();
            }
        ...
        public Boolean CompruebaEnlaceTienda(string tienda)
        {
            ...
            if (tienda == "VALLARTA")
            {
                try
                {
                    conex_prueba = BDConexicon.V_vallarta();
                    conex_prueba.Close();
                    flag = true;
                }
                catch
            ...
            else if (tienda == "RENA")
            {
                try
                {
                    conex_prueba = BDConexicon.V_rena();
                    conex_prueba.Close();
                    flag = true;
                }
                catch
            ...
            else if (tienda == "VELAZQUEZ")
            {
                try
                {
                    conex_prueba = BDConexicon.V_velazquez();
                    conex_prueba.Close();
                    flag = true;
                }
                catch
            ...
            else if (tienda == "COLOSO")
            {
                try
                {
                    conex_prueba = BDConexicon.V_coloso();
                    conex_prueba.Close();
                    flag = true;
                }
                catch
            ...
            else if (tienda == "PREGOT")
            {
                try
                {
                    conex_prueba = BDConexicon.V_pregot();
                    conex_prueba.Close();
                    flag = true;
                }
                catch
        ...
        public void TiendaOrigen(string tienda)
        {
            ...
            if (tienda == "VALLARTA")
            {
                conex_bajatraspaso = BDConexicon.V_vallarta();
                bajaTraspaso();
                conex_bajatraspaso.Close();
            }
            else if (tienda == "RENA")
            {
                conex_bajatraspaso = BDConexicon.V_rena();
                bajaTraspaso();
                conex_bajatraspaso.Close();
            }
            else if (tienda == "VELAZQUEZ")
            {
                conex_bajatraspaso = BDConexicon.V_velazquez();
                bajaTraspaso();
                conex_bajatraspaso.Close();
            }
            else if (tienda == "COLOSO")
            {
                conex_bajatraspaso = BDConexicon.V_coloso();
                bajaTraspaso();
                conex_bajatraspaso.Close();
            }
            else if (tienda == "PREGOT")
            {
                conex_bajatraspaso = BDConexicon.V_pregot();
                bajaTraspaso();
                conex_bajatraspaso.Close();
            }
        ...
        public void TiendaDestino(string tienda)
        {
            ...
            if (tienda == "VALLARTA")
            {
                conex_altatraspaso = BDConexicon.V_vallarta();
                altaTraspaso();
                conex_altatraspaso.Close();
            }
            else if (tienda == "RENA")
            {
                conex_altatraspaso = BDConexicon.V_rena();
                altaTraspaso();
                conex_altatraspaso.Close();
            ...
            {
                conex_altatraspaso = BDConexicon.V_velazquez();
                altaTraspaso();
                conex_altatraspaso.Close();
            }
            else if (tienda == "COLOSO")
            {
                conex_altatraspaso = BDConexicon.V_coloso();
                altaTraspaso();
                conex_altatraspaso.Close();
            }
            ...
            {
                conex_altatraspaso = BDConexicon.V_pregot();
                altaTraspaso();
                conex_altatraspaso.Close();
            }
