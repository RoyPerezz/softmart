...
{
    public partial class ComisionesJefeAlmacenCedis : Form
    {
        public ComisionesJefeAlmacenCedis()
        {
            InitializeComponent();
        }
        double totalAcumulado = 0;
        private void ComisionesJefeAlmacenCedis_Load(object sender, EventArgs e)
        {
